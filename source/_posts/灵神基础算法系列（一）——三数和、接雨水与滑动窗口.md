...
categories: 算法学习
---
本篇文章主要为灵神基础算法系列的第一期到第三期。这几个视频的主要内容是灵活使用双指针，去实现便捷快速的解题。灵活利用指针的时间复杂度与空间复杂度往往超越暴力解题很多很多，作者想和大家分享一下自己在学习时的心得，以下代码都是c++。
